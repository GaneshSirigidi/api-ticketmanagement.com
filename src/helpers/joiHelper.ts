...
const stringErrorHandler = (errors: any, label?: any, message?: any, refKey?: any) => {
...
const numberErrorHandler = (errors: any, label?: any) => {
    errors.forEach((err: any) => {
...
const arrayErrorHandler = (errors: any, label?: any, required = false) => {
    errors.forEach((err: any) => {
